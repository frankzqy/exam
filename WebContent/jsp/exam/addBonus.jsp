	...
	$(function() {
		$("#saveForm").Validform({
			...
			callback:function(form){
				...
				$.ajax({
	            	"url": "<%=request.getContextPath()%>/service/bonus/get",
	            	"type": "GET",
...
<body>
	...
	<div class="container text-center" id="sandbox-container">
	  <h2 class="text-left htext">新增年终奖发放员工</h2>
	  <hr class="fenge"/>
	  <br/>
	  <div class="col-xs-10 col-md-10">	  
		<form class="form-horizontal" id="saveForm" name="saveForm" onsubmit="return false">
			<div class="form-group">
				<label class="col-xs-3 col-md-3 control-label">工号<span class="required">*</span></label>
				<div class="col-xs-8 col-md-8">
					<input type="text" class="form-control ue-form Validform_input" id="staffId" name="staffId"  
						placeholder="工号" datatype="s1-12" errormsg="工号1~12个字符！" nullmsg="请输入工号" />						
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-md-8">
					<input type="text" class="form-control ue-form Validform_input" id="staffName"
						name="staffName" placeholder="姓名" datatype="s1-18" errormsg="姓名1~18个字符！" nullmsg="请输入名称"/>						
					<span class="Validform_checktip Validform_span"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-md-8">
					<input type="text" class="form-control ue-form Validform_input" id="wages"
						name="wages"  datatype="math" errormsg="请输入数字！" nullmsg="请输入月工资"
						placeholder="月工资标准" />	
					<span class="Validform_checktip Validform_span"></span>	
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-md-8">
					<input type="text" class="form-control ue-form Validform_input" id="totalBonus"
						name="totalBonus"  datatype="math" errormsg="请输入数字！" nullmsg="请输入年终奖"
						placeholder="年终奖" />	
					<span class="Validform_checktip Validform_span"></span>	
				</div>
			</div>
