...
<head>
	...
	$(function(){
		$("#saveForm").Validform({
			...
			callback:function(form){
				...
				$.ajax({
	            	"url": context + "/service/stafftax/get",
	            	"type": "GET",
	...
	//保存实例
	function save(){
		var url = context + "/service/stafftax/save";
	    saveForm.action = url;
...
<body>
	...
	<div class="container text-center" id="sandbox-container">
	   <h2 class="text-left htext">新增员工</h2>
	   <hr class="fenge"/>
	   <br/>
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-md-8">
					<input type="text" class="form-control ue-form Validform_input" id="staffId"
						name="staffId"
						placeholder="工号" datatype="s1-12" errormsg="名称1~12字符！" nullmsg="请设置正确工号" />						
			...
			<div class="form-group">
				...
				<div class="col-xs-8 col-md-8">
					<input type="text" class="form-control ue-form Validform_input" id="wages"
						name="wages"  datatype="math" errormsg="请输入数字！" ignore="ignore"
						placeholder="月工资标准" />	
					<span class="Validform_checktip Validform_span"></span>	
				</div>
			</div>
