...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Henter...</div>';
...
if(L5.grid.GridPanel){
   L5.grid.GridPanel.prototype.ddText = "{0} markerede rækker";
}

if(L5.TabPanelItem){
   L5.TabPanelItem.prototype.closeText = "Luk denne fane";
}

if(L5.form.Field){
   L5.form.Field.prototype.invalidText = "Værdien i dette felt er ugyldig";
}

if(L5.LoadMask){
    L5.LoadMask.prototype.msg = "Henter...";
}
