...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Cargando...</div>';
...
if(L5.grid.GridPanel){
  L5.grid.GridPanel.prototype.ddText = "{0} fila(s) seleccionada(s)";
}

if(L5.LoadMask){
  L5.LoadMask.prototype.msg = "Cargando...";
}
...
if(L5.form.Field){
  L5.form.Field.prototype.invalidText = "El valor en este campo es inv&#225;lido";
}
