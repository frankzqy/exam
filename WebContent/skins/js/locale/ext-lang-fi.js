...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Ladataan...</div>';
...
if(L5.grid.GridPanel){
  L5.grid.GridPanel.prototype.ddText = "{0} rivi(ä) valittu";
}

if(L5.TabPanelItem){
  L5.TabPanelItem.prototype.closeText = "Sulje tämä välilehti";
}

if(L5.LoadMask){
  L5.LoadMask.prototype.msg = "Ladataan...";
}
...
if(L5.form.Field){
  L5.form.Field.prototype.invalidText = "Tämän kentän arvo ei kelpaa";
}
...
if(L5.form.BasicForm){
  L5.form.BasicForm.prototype.waitTitle = "Odota...";
}
