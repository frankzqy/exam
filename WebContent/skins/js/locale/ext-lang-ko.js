...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">로딩중...</div>';
...
if(L5.grid.GridPanel){
   L5.grid.GridPanel.prototype.ddText = "{0} 개가 선택되었습니다.";
}

if(L5.TabPanelItem){
   L5.TabPanelItem.prototype.closeText = "닫기";
}

if(L5.form.Field){
   L5.form.Field.prototype.invalidText = "올바른 값이 아닙니다.";
}

if(L5.LoadMask){
    L5.LoadMask.prototype.msg = "로딩중...";
}
