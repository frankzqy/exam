...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Kraunasi...</div>';
...
if(L5.grid.GridPanel){
  L5.grid.GridPanel.prototype.ddText = "{0} pažymėta";
}

if(L5.TabPanelItem){
  L5.TabPanelItem.prototype.closeText = "Uždaryti šią užsklandą";
}

if(L5.form.Field){
  L5.form.Field.prototype.invalidText = "Šio lauko reikšmė neteisinga";
}

if(L5.LoadMask){
  L5.LoadMask.prototype.msg = "Kraunasi...";
}
