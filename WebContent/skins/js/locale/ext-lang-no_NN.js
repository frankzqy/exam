...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Lastar...</div>';
...
if(L5.TabPanelItem){
  L5.TabPanelItem.prototype.closeText = "Lukk denne fana";
}
...
if(L5.LoadMask){
  L5.LoadMask.prototype.msg = "Lastar...";
}
