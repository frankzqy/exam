...
L5.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">Триває завантаження...</div>';
...
if(L5.grid.GridPanel){
   L5.grid.GridPanel.prototype.ddText = "{0} вибраних стрічок";
}

if(L5.TabPanelItem){
   L5.TabPanelItem.prototype.closeText = "Закрити цю вкладку";
}

if(L5.form.Field){
   L5.form.Field.prototype.invalidText = "Значення у цьому полі невірне";
}

if(L5.LoadMask){
   L5.LoadMask.prototype.msg = "Завантаження...";
}
