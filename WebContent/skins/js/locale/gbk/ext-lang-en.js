...
L5.connectionError="connect to server failed";
L5.turnPage="page num too large or too small";
L5.turnPageFirst="page num too large";
L5.turnPageLast="page num too small";
L5.di="the";
L5.hang="row";
L5.lie="column";
L5.valError="validate error";
L5.parseReturnError="parse return value error";
L5.loadDateError="load date error:";
L5.radio="select";